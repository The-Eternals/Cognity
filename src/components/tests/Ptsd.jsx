...
const Ptsd = () => {
    ...
    const questions = [
        {
            questionText: "Had nightmares about the event(s) or thought about the event(s) when you did not want to?",
            answerOptions: [
        ...
        {
            questionText: "Tried hard not to think about the event(s) or went out of your way to avoid situations that reminded you of the event(s)?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "Felt numb or detached from people, activities, or your surroundings?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "Felt guilty or unable to stop blaming yourself or others for the event(s) or any problems the event(s) may have caused?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
