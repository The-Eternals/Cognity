...
const Bipolar = () => {
    ...
    const questions = [
        {
            questionText: "Has there ever been a period of time when you were not your usual self",
            answerOptions: [
        ...
        {
            questionText: "You were much more social or outgoing than usual, for example, you telephoned friends in the middle of the night?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "You got much less sleep than usual and found you didn’t really miss it?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "You were so irritable that you shouted at people or started fights or arguments?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "Thoughts raced through your head or you couldn’t slow your mind down?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "You were so easily distracted by things around you that you had trouble concentrating or staying on track?",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
        ...
        {
            questionText: "Have any of your blood relatives had manic-depressive illness or bipolar disorder?i.e. Children, siblings, parents, grandparents, aunts, and uncles.",
            answerOptions: [
                { answerText: "Not at all", marks: 0 },
                { answerText: "Few Times", marks: 1 },
                { answerText: "More than half the number of Times", marks: 2 },
