        ...
        <Fragment>
            <div className="px-[8rem] flex justify-between py-20">
                ...
                <div className="w-[34rem] mt-20">
                    ...
                    <button className=" bg-[#ec744a] text-white rounded-xl font-semibold px-8 h-10 hover:bg-white hover:text-[#ec744a] hover:border-[#ec744a] hover:border-2 mt-16">See Deatails</button>
                </div>
            </div>
        </Fragment>
    )
